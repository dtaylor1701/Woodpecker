...
final class SyncedModelServiceTests {
  ...
  @Test func add() async throws {
    ...
    _ = try await siblingService.add(sibling)
  ...
  @Test func update() async throws {
    ...
    _ = try await service.update(toUpdate)
    ...
    _ = try await siblingService.add(firstNewSibling)
    _ = try await siblingService.add(secondNewSibling)
  ...
  @Test func delete() async throws {
    ...
    _ = try await service.add(toDelete)
  ...
  @Test func find() async throws {
    ...
    _ = try await service.add(toFind)
